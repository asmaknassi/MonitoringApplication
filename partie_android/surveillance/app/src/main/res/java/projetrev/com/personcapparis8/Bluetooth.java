...
public class Bluetooth extends Activity implements OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        init();
        if (btAdapter == null) {
            Toast.makeText(getApplicationContext(), "pas de bluetooth", Toast.LENGTH_LONG).show();
            finish();
        } else {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_CANCELED) {
            Toast.makeText(getApplicationContext(), "activez votre bluetooth pour continuer", Toast.LENGTH_SHORT).show();
            finish();
        }
    }
